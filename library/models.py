...
class Loan(models.Model):
    ...
    # for the sake of idempotency, we need to add a flag that will be off/no when email is sent
    has_daily_overdue_loan_notification_sent = models.BooleanField(default=False)
